...
ActiveRecord::Schema[7.0].define(version: 2022_12_11_190329) do
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.string "score"
    t.string "grade"
    t.index ["presentation_id"], name: "index_reviews_on_presentation_id"
    t.index ["user_id", "presentation_id"], name: "index_reviews_on_user_id_and_presentation_id", unique: true
  end
  ...
  add_foreign_key "reviews", "presentations"
