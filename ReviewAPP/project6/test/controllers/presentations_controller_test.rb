...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference("Presentation.count") do
      post presentations_url, params: { presentation: { name: @presentation.name, user_id: @presentation.user_id } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { name: @presentation.name, user_id: @presentation.user_id } }
